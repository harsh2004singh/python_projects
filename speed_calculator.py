...
test = [("I met a traveller from an antique land, Who said, 'Two vast and trunkless legs of stone Stand in the desert. Near /n"
...
print('speed : ',speed_calculator(time1,time2,testinput),"w/sec")
